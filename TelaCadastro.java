...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    public TelaCadastro(Usuario us) {
        ...
        initComponents();
        setLocationRelativeTo(null);
        this.jTextField1.setText(this.user.getNome());
        this.jTextField3.setText(this.user.getEmail());
        this.jTextField2.setText(this.user.getCidade());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (confere.equals(conf)) {
            ConexaoDataBase conDt = new ConexaoDataBase();
            conDt.conectar();
            try {
                conDt.conectarCadastro( jTextField3.getText(), jTextField1.getText(), jTextField2.getText(), new String(jPasswordField1.getPassword()) );
